...
const projects = {import { useState } from "react";
import { motion, AnimatePresence } from "framer-motion";
...
import AnimationBubble from "../assets/Animation-bubble.png";
  ...
  frontend: [
    {
      ...
      description:
        "Modern React landing page with smooth animations, responsive design, and clear sections for portfolio presentation",
    },
    {
      name: "Apple website",
      image: Apple,
      ...
      description:
        "A sleek, responsive iPhone landing page showcasing features, design, and innovation with modern animations.",
    },
    {
      ...
      description:
        "Simple and responsive expense tracker to manage your budget with real-time balance updates and history",
    },
    {
      name: "Recipe Website",
      image: Receipe,
      ...
      description:
        "Search and discover recipes with ingredients and instructions using a clean, responsive interface and API.",
    },
    {
      ...
      description:
        "Generate QR codes instantly for any text or URL using a simple and responsive interface.",
    },
    {
      name: "Todo List",
      image: Todo,
      liveLink: "https://sameer7-web.github.io/todo-list/",
      codeLink: "https://github.com/sameer7-web/todo-list",
      description:
        "Organize daily tasks efficiently with this clean, minimal, and responsive todo list web application.",
    },
  ],
  animation: [
    {
      name: "Animated Landing Page",
      image: AnimationBubble,
      liveLink: "https://mini-portfolio-phi-blond.vercel.app/",
      codeLink: "https://github.com/sameer7-web/Mini-Portfolio",
      description:
        "Showcases frontend skills, projects, and contact details with a smooth, responsive, and visually appealing layout.",
    },
    {
      name: "3D Robot Page",
      image: AIRobot,
      ...
      description:
        "Personal AI-powered portfolio with interactive elements, modern animations, and responsive design to showcase developer profile.",
    },
  ],
};
